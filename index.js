    ...
    init : function (){  
        ...
        this.el.addEventListener("click", function(e) {
            ...
            if (current == "#intersect2") {
                ...
                arrow_left.setAttribute("position", " 3 2 2 ");
                arrow_forward.setAttribute("position", "2.25 1 5");
                arrow_forward.setAttribute("animation","property:position;from: 2.25 1 5 ; to:2.25 1.2 5; loop: true; dir: alternate; easing: linear")

                arrow_right.setAttribute("rotation", "0 -100 0");
                arrow_back.setAttribute("rotation", "0 30 0");
                arrow_left.setAttribute("rotation", "");
            ...
            if (current == "#TQB") {
              ...
              arrow_right.setAttribute("position", "2 1 0");
              arrow_right.setAttribute("animation","property:position;from: 2 1 0 ; to: 2 1 0; loop: true; dir: alternate; easing: linear")

              arrow_back.setAttribute("position", "-5 1 -1");
              arrow_back.setAttribute("animation","property:position;from: -5 1 -1 ; to: -4 1 -1; loop: true; dir: alternate; easing: linear")

              arrow_left.setAttribute("position", " 3 2 2 ");
              arrow_forward.setAttribute("position", "3 3 3");

              arrow_right.setAttribute("rotation", "30 30 30");
              arrow_back.setAttribute("rotation", "30 0 30");
              arrow_left.setAttribute("rotation", "");
